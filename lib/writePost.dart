...
import 'package:discussion/controllers/FBStorage.dart';
...
class _WritePost extends State<WritePost> {
  ...
  TextEditingController writingTextController2 = TextEditingController();
  ...
  void _postToFB() async {
    ...
    FBCloudStore.sendPostInFirebase(postID, writingTextController2.text,
        writingTextController.text, widget.myData, postImageURL ?? 'NONE');
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Enter your subject name first ',
                              hintMaxLines: 4,
                            ),
                            controller: writingTextController2,
